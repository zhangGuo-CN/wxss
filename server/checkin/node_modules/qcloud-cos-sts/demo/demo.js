...
// 配置参数
var config = {
    secretId: 'AKIDOYSbWAVdaGfnwsFu4ybxazSgcomUm76q',   // 固定密钥
    secretKey: 'pOq65nERO3VEm33pumSrHSMzLfpiS5TN',  // 固定密钥
    proxy: '',
    durationSeconds: 1800,  // 密钥有效期
    // 放行判断相关参数
    bucket: 'wxss-1300917475', // 换成你的 bucket
    region: 'ap-chongqing', // 换成 bucket 所在地区
